...
ActiveRecord::Schema[7.0].define(version: 2024_04_11_051327) do
  ...
  create_table "coordinates", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["earthquake_id"], name: "index_coordinates_on_earthquake_id"
  end
  ...
  add_foreign_key "coordinates", "earthquakes"
end
